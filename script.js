document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateField(field) {
        ...
        if (field.hasAttribute('required') && !value) {
            ...
            if (type === 'tel' || name === 'phone' || name === 'telephone') {
            ...
            if (field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'))) {
                isValid = false;
                errorMessage = field.dataset.errorMinlength || `Minimum ${field.getAttribute('minlength')} characters required`;
            }
            
            if (field.hasAttribute('maxlength') && value.length > parseInt(field.getAttribute('maxlength'))) {
                isValid = false;
                errorMessage = field.dataset.errorMaxlength || `Maximum ${field.getAttribute('maxlength')} characters allowed`;
            }
    ...
    function handleFormInput(e) {
        ...
        if (!field) return;
        if (!contactForm || !contactForm.contains(field)) return;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ec2b2643-e694-4bfc-8633-d47f5e6af205',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ec2b2643-e694-4bfc-8633-d47f5e6af205';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ec2b2643-e694-4bfc-8633-d47f5e6af205';
